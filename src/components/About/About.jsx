...
export default function About() {
  return (
    <div>
      ...
      <div id="textarea">
      <p>
      Thank you for taking the time to check out my react portfolio. My name is Jeff Hicks and I currently reside in the PNW. I started my coding journey in March of 2022. I'm expected to graduate from the University of Washington coding boot-camp on June 13th, 2022. 
        <br />
        <br />
        I decided to jump into coding as I have a passion for technology. My love for technology was first discovered when I got a job at Blueprint Consulting Services as a Team Lead for customer support. Blueprint is a technology consulting firm that received a bid for customer support. During my time at Blueprint I had the privilege to get a view of the technology industry and be a part of a team that operated as such. 
        <br />
        <br />
